...
export default function PropertyCard({ property, onViewDetails }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-3xl overflow-hidden border border-stone-200 hover:border-[#FFD300] hover:shadow-lg transition-all duration-300 cursor-pointer group"
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="mb-3">
          <p className="text-2xl font-bold bg-gradient-to-r from-amber-600 via-amber-500 to-yellow-500 bg-clip-text text-transparent mb-1">
            {formatPrice()}
          </p>
        ...
        {/* Title */}
        <h3 className="text-lg font-bold text-[#111111] mb-2 leading-tight line-clamp-2 group-hover:text-[#FFD300] transition-colors">
        ...
        <div className="space-y-2">
          <Button
            ...
            className="w-full bg-[#25D366] hover:bg-[#20BD5A] text-white font-bold rounded-2xl h-11 flex items-center justify-center gap-2"
          >
          ...
          <Button
            ...
            className="w-full bg-[#128C7E] hover:bg-[#0F7A6E] text-white font-bold rounded-2xl h-11 flex items-center justify-center gap-2"
          >
            <MessageCircle className="w-4 h-4" />
