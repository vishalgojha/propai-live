...
// Removed: Tabs, TabsContent, TabsList, TabsTrigger as they are replaced by custom navigation
import { 
...
export default function Admin() {
  ...
  // Removed: Helper to create page URLs - now imported from @/utils
  ...
  const handleViewListings = (broker) => {
    // Navigate to properties filtered by broker
  ...
  return (
    <div className="min-h-screen bg-[#F7F7F7]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
        ...
        {/* Replaced Tabs with custom vertical navigation */}
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Vertical Tabs Sidebar */}
          <div className="lg:w-64 flex-shrink-0">
            <div className="bg-white rounded-2xl border-2 border-[#F7F7F7] p-2 sticky top-24">
